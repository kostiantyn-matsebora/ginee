...
1. `.agents/ginee/core/roles/backend-engineer.md` — your full charter (D25 — doc-authorship + propose-architectural-change path added)
...
5. `.agents/ginee/local/roles/backend-engineer.md` — project-local extension (D37 — load if present; augments this charter with project-specific craft notes; never replaces)
