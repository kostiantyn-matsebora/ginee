...
# D31 — standard tier; override via local/framework.config.yaml § model-tier.per-role.qa-engineer
...
5. `.agents/ginee/local/roles/qa-engineer.md` — project-local extension (D37 — load if present; augments this charter with project-specific craft notes; never replaces)
