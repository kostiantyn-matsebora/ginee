...
> ## Reporting
>
> Schema-bound per `core/templates/phase-report.md`; self-lint against the 6 mandatory checks before report-as-done. Coverage attestation — threshold + runner outcome — lands as a `## Verification log` row.
> ```
>
