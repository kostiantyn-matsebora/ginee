...
$legacyFrameworkName = 'engineering-team'  # codename retired in D11 rebrand (2026-05-18)
...
if (Test-Path $localDir) {
  $staleLocalHits = [bool](Get-ChildItem $localDir -Recurse -File -ErrorAction SilentlyContinue |
    Select-String -Pattern $legacyFrameworkName -SimpleMatch -List -ErrorAction SilentlyContinue |
